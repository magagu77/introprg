...
public class Hora {
    ...
    public void incrementa(int segons) throws Exception{
        int hora=0;
        int minuts=0;
        if (segons <  0) {
    ...
    // hace los augmentos
    public void incrementa(int hora, int minuts, int segons) throws Exception{
    ...
    public void decrementa(int segons) throws Exception{
        int hora=0;
        int minuts=0;
        if (segons <  0) {
    ...
    public void decrementa(int hora, int minuts, int segons) throws Exception{
        if (hora > 24){
            int numVueltas = hora/24;
            hora = hora - numVueltas * 24;
        }

...
public class ManipulaString {
	public static void main(String[] args) {
			...
			System.out.println("La composició de quatre és \"" + Character.toLowerCase(paraula.charAt((paraula.length() - 1))) + Character.toUpperCase(paraula.charAt(0)) + Character.toLowerCase(paraula.charAt(2)) + Character.toLowerCase(paraula.charAt(3)) + "\"");
			System.out.println("La composició de quatre corregint majúscules és \"" + Character.toUpperCase(paraula.charAt((paraula.length() - 1))) + Character.toLowerCase(paraula.charAt(0)) + Character.toLowerCase(paraula.charAt(2)) + Character.toLowerCase(paraula.charAt(3)) + "\"");
		}	
}   